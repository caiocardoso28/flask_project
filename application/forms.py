...
class RegistrationForm(FlaskForm):
    ...
    def validate_email(self, email):
        ...
        if user:
            raise ValidationError('Email is taken. Please log in with your credentials.')
...
class PostForm(FlaskForm):
    title = TextAreaField(label='Content')
    content = FileField(label='Upload Content', validators=[
        FileAllowed(('jpeg', 'jpg', 'png', 'mp4'))
    ])
